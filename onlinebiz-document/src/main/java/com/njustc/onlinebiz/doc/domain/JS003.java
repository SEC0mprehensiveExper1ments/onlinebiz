...
public class JS003 {
    ...
    public String getZiGongNengName(int index,int j){
        return inputRuanJianGongNengXiangMu.get(index).getInputZiGongNeng().get(j).getInputZiGongNengMingCheng();
    }

    public String getZiGongNengShuoMing(int index,int j){
        return inputRuanJianGongNengXiangMu.get(index).getInputZiGongNeng().get(j).getInputGongNengShuoMing();
    }
}
