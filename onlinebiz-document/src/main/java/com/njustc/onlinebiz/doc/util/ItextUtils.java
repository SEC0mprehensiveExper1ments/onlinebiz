...
//        cell.setBorder(haveBorder);
    ...
    public static PdfPCell createCell_Height_Leading(String value, Font font, int align, int colspan, int rowspan, float height, float leading, float[] paddings, float borderWidth) {
        PdfPCell cell = new PdfPCell();
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setHorizontalAlignment(align);
        cell.setColspan(colspan);
