...
public class DocServiceJS004 {
    ...
    * */
    public boolean fill(JS004 newJson) {
        ...
        // 添加图章
        try {
            String[] sealPath = new String[]{absolutePath + "seal/seal_demo.jpg", absolutePath + "seal/seal_demo.jpg"};
    ...
    public static void generatePageOne(Document document) throws Exception {
        ...
        PdfPTable table = ItextUtils.createTable(new float[] {tableWidth/2 - 45, tableWidth/2 + 45}, maxWidth);
        table.addCell(ItextUtils.createCell("项目名称 ：", titlefont2, Element.ALIGN_RIGHT, ItextUtils.NO_BORDER, new float[]{40f+5f, 40f, 0f, 0f}));
        table.addCell(ItextUtils.createCell(JS004Json.getInputXiangMuMingChen(), new Font(bfHeiTi, 16, Font.NORMAL), Element.ALIGN_LEFT, Element.ALIGN_TOP, ItextUtils.NO_BORDER, new float[]{40f, 0f, 0f, 0f}, 0.3f, 20f));
        table.addCell(ItextUtils.createCell("委托方（甲方）：", titlefont2, Element.ALIGN_RIGHT, ItextUtils.NO_BORDER, new float[]{40f+5f, 40f, 0f, 0f}));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang(), new Font(bfHeiTi, 16, Font.NORMAL), Element.ALIGN_LEFT, Element.ALIGN_TOP, ItextUtils.NO_BORDER, new float[]{40f, 0f, 0f, 0f}, 0.3f, 20f));
        table.addCell(ItextUtils.createCell("委托方（乙方）：", titlefont2, Element.ALIGN_RIGHT, ItextUtils.NO_BORDER, new float[]{40f+5f, 40f, 0f, 0f}));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang(), new Font(bfHeiTi, 16, Font.NORMAL), Element.ALIGN_LEFT, Element.ALIGN_TOP, ItextUtils.NO_BORDER, new float[]{40f, 0f, 0f, 0f}, 0.3f, 20f));

        PdfPTable table2 = ItextUtils.createTable(new float[] {tableWidth/2-40, tableWidth/2+40}, maxWidth);
        table2.addCell(ItextUtils.createCell("签订地点 ：", titlefont2, Element.ALIGN_RIGHT, ItextUtils.NO_BORDER, new float[]{20f+5f, 20f, 0f, 0f}));
        table2.addCell(ItextUtils.createCell(JS004Json.getInputQianDingDiDian(), new Font(bfHeiTi, 16, Font.NORMAL), Element.ALIGN_LEFT, Element.ALIGN_TOP, ItextUtils.NO_BORDER, new float[]{20f, 0f, 0f, 0f}, 0.3f, 20f));
        table2.addCell(ItextUtils.createCell("签订日期 ：", titlefont2, Element.ALIGN_RIGHT, ItextUtils.NO_BORDER, new float[]{20f, 20f, 0f, 0f}));
        ...
        table2.addCell(ItextUtils.createCell(new String[]{"", "  \u0232", nian, "年", yue, "月", ri, "日"}, new Font(bfHeiTi, 16, Font.NORMAL), new Font(bfHeiTi, 16, Font.BOLD), Element.ALIGN_LEFT, Element.ALIGN_MIDDLE, ItextUtils.NO_BORDER, 1, 1, new float[]{20f, 20f, 0f, 0f}, 0.3f));
...
//        chunk5.setUnderline(0.3f, -3f);
    ...
    public static void generatePageFour(Document document) throws Exception {
        ...
        text2.add(new Phrase(
                "    双方因履行本合同所发生的一切争议，应通过友好协商解决；如协商解决不成，" +
                        "就提交市级仲裁委员会进行仲裁。裁决对双方当事人具有同等约束力。\n", textfont));
        text2.setSpacingAfter(30f); //设置段落下空白
    ...
    public static void generatePageFive(Document document) throws Exception {
        ...
        table.addCell(ItextUtils.createCell("委\n\n\n\n托\n\n\n\n方", textfont, Element.ALIGN_CENTER, 2, 18, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("单位全称\n\n\n\n", textfont, Element.ALIGN_CENTER, 5, 5, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang() + "\n\n\n（签章）\n", textfont, Element.ALIGN_CENTER, 23, 5, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("授权代表", textfont, Element.ALIGN_CENTER, 5, 3, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang0ShouQuanDaiBiao(), textfont, Element.ALIGN_CENTER, 9, 3, paddings, borderWidth));
        table.addCell(ItextUtils.createCell("签章日期", textfont, Element.ALIGN_CENTER, 3, 3, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang0QianZhangRiQi(), textfont, Element.ALIGN_CENTER, 11, 3, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("联系人", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang0LianXiRen(), textfont, Element.ALIGN_CENTER, 23, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("通讯地址", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang0TongXunDiZhi(), textfont, Element.ALIGN_CENTER, 23, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("电话", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang0DianHua(), textfont, Element.ALIGN_CENTER, 9, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell("传真", textfont, Element.ALIGN_CENTER, 3, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang0ChuanZhen(), textfont, Element.ALIGN_CENTER, 11, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("开户银行", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang0KaiHuYinHang(), textfont, Element.ALIGN_CENTER, 23, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("账号", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang0ZhangHao(), textfont, Element.ALIGN_CENTER, 9, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell("邮编", textfont, Element.ALIGN_CENTER, 3, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputJiaFang0YouBian(), textfont, Element.ALIGN_CENTER, 11, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("受\n\n\n\n托\n\n\n\n方", textfont, Element.ALIGN_CENTER, 2, 20, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("单位全称\n\n\n\n", textfont, Element.ALIGN_CENTER, 5, 5, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang() + "\n\n\n（签章）\n", textfont, Element.ALIGN_CENTER, 23, 5, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("授权代表", textfont, Element.ALIGN_CENTER, 5, 3, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0ShouQuanDaiBiao(), textfont, Element.ALIGN_CENTER, 9, 3, paddings, borderWidth));
        table.addCell(ItextUtils.createCell("签章日期", textfont, Element.ALIGN_CENTER, 3, 3, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0QianZhangRiQi(), textfont, Element.ALIGN_CENTER, 11, 3, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("联系人", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0LianXiRen(), textfont, Element.ALIGN_CENTER, 23, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("通讯地址", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0TongXunDiZhi(), textfont, Element.ALIGN_CENTER, 23, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("电话", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0DianHua(), textfont, Element.ALIGN_CENTER, 9, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell("传真", textfont, Element.ALIGN_CENTER, 3, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0ChuanZhen(), textfont, Element.ALIGN_CENTER, 11, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("户名", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0HuMing(), textfont, Element.ALIGN_CENTER, 23, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("开户银行", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0KaiHuYinHang(), textfont, Element.ALIGN_CENTER, 23, 2, paddings, borderWidth));

        table.addCell(ItextUtils.createCell("账号", textfont, Element.ALIGN_CENTER, 5, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0ZhangHao(), textfont, Element.ALIGN_CENTER, 9, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell("邮编", textfont, Element.ALIGN_CENTER, 3, 2, paddings, borderWidth));
        table.addCell(ItextUtils.createCell(JS004Json.getInputYiFang0YouBian(), textfont, Element.ALIGN_CENTER, 11, 2, paddings, borderWidth));
