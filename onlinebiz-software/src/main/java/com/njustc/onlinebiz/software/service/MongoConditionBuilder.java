...
public class MongoConditionBuilder implements ConditionBuilder {
    ...
    @Override
    public ConditionBuilder bySoftwareName(String softwareName) {
        if (softwareName != null) {
            String pattern = convertToSubSeqPattern(softwareName);
            condition.append("{softwareName:{$regex:'").append(pattern).append("'}},");
        }
        return this;
    }
